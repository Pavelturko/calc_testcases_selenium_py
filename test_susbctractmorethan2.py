...
class TestSusbctractmorethan2():
  ...
  def test_susbctractmorethan2(self):
    self.driver.get("http://qa-test.klika-tech.com/")
    self.driver.set_window_size(1074, 824)
    self.driver.find_element(By.CSS_SELECTOR, ".digits > li:nth-child(6)").click()
    ...
    assert self.driver.find_element(By.ID, "display").text == "2"
