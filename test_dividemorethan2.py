...
class TestDividemorethan2():
  ...
  def test_dividemorethan2(self):
    self.driver.get("http://qa-test.klika-tech.com/")
    self.driver.set_window_size(1078, 824)
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".operations > li:nth-child(4)").click()
    ...
    assert self.driver.find_element(By.ID, "display").text == "1"
